...
function ocultarElementos(data){
    ...
    for(oculto = 0; oculto < data.length; oculto++){
        var ocultar = document.getElementById("Equipo" + oculto); 
...
function ClickEquipo(id, data) {
    ocultarElementos(data)
    var equipoMostrar = document.getElementById("Equipo" + id); 
